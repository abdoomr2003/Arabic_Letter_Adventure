...
const RAW: RawLetter[] = [
  {
    id: 'alif', char: 'ا', nameAr: 'ألف', nameEn: 'Alif', translit: 'a', sound: '/aː/',
  ...
  {
    id: 'baa', char: 'ب', nameAr: 'باء', nameEn: 'Baa', translit: 'b', sound: '/b/',
  ...
  {
    id: 'taa', char: 'ت', nameAr: 'تاء', nameEn: 'Taa', translit: 't', sound: '/t/',
  ...
  {
    id: 'thaa', char: 'ث', nameAr: 'ثاء', nameEn: 'Thaa', translit: 'th', sound: '/θ/',
  ...
  {
    id: 'jeem', char: 'ج', nameAr: 'جيم', nameEn: 'Jeem', translit: 'j', sound: '/dʒ/',
  ...
  {
    id: 'haa-h', char: 'ح', nameAr: 'حاء', nameEn: 'Haa', translit: 'ḥ', sound: '/ħ/',
  ...
  {
    id: 'khaa', char: 'خ', nameAr: 'خاء', nameEn: 'Khaa', translit: 'kh', sound: '/x/',
  ...
  {
    id: 'dal', char: 'د', nameAr: 'دال', nameEn: 'Dal', translit: 'd', sound: '/d/',
  ...
  {
    id: 'thal', char: 'ذ', nameAr: 'ذال', nameEn: 'Dhal', translit: 'dh', sound: '/ð/',
  ...
  {
    id: 'raa', char: 'ر', nameAr: 'راء', nameEn: 'Raa', translit: 'r', sound: '/r/',
  ...
  {
    id: 'zay', char: 'ز', nameAr: 'زاي', nameEn: 'Zay', translit: 'z', sound: '/z/',
  ...
  {
    id: 'seen', char: 'س', nameAr: 'سين', nameEn: 'Seen', translit: 's', sound: '/s/',
  ...
  {
    id: 'sheen', char: 'ش', nameAr: 'شين', nameEn: 'Sheen', translit: 'sh', sound: '/ʃ/',
  ...
  {
    id: 'sad', char: 'ص', nameAr: 'صاد', nameEn: 'Sad', translit: 'ṣ', sound: '/sˤ/',
  ...
  {
    id: 'dad', char: 'ض', nameAr: 'ضاد', nameEn: 'Dad', translit: 'ḍ', sound: '/dˤ/',
  ...
  {
    id: 'taa-t', char: 'ط', nameAr: 'طاء', nameEn: 'Taa (heavy)', translit: 'ṭ', sound: '/tˤ/',
  ...
  {
    id: 'zaa', char: 'ظ', nameAr: 'ظاء', nameEn: 'Zaa (heavy)', translit: 'ẓ', sound: '/ðˤ/',
  ...
  {
    id: 'ayn', char: 'ع', nameAr: 'عين', nameEn: 'Ayn', translit: 'ʿ', sound: '/ʕ/',
  ...
  {
    id: 'ghayn', char: 'غ', nameAr: 'غين', nameEn: 'Ghayn', translit: 'gh', sound: '/ɣ/',
  ...
  {
    id: 'faa', char: 'ف', nameAr: 'فاء', nameEn: 'Faa', translit: 'f', sound: '/f/',
  ...
  {
    id: 'qaf', char: 'ق', nameAr: 'قاف', nameEn: 'Qaf', translit: 'q', sound: '/q/',
  ...
  {
    id: 'kaf', char: 'ك', nameAr: 'كاف', nameEn: 'Kaf', translit: 'k', sound: '/k/',
  ...
  {
    id: 'lam', char: 'ل', nameAr: 'لام', nameEn: 'Lam', translit: 'l', sound: '/l/',
  ...
  {
    id: 'meem', char: 'م', nameAr: 'ميم', nameEn: 'Meem', translit: 'm', sound: '/m/',
  ...
  {
    id: 'noon', char: 'ن', nameAr: 'نون', nameEn: 'Noon', translit: 'n', sound: '/n/',
  ...
  {
    id: 'haa-soft', char: 'ه', nameAr: 'هاء', nameEn: 'Haa (soft)', translit: 'h', sound: '/h/',
  ...
  {
    id: 'waw', char: 'و', nameAr: 'واو', nameEn: 'Waw', translit: 'w', sound: '/w/',
  ...
  {
    id: 'yaa', char: 'ي', nameAr: 'ياء', nameEn: 'Yaa', translit: 'y', sound: '/j/',
